...
type (
	// Error is a storage error interface
	Error struct {
		...
		StatusCode int    `json:"-"`
		// TODO parse additional errors array: https://developer.akamai.com/api/media_delivery/netstorage_configuration/v1.html#errors
	}
)

// Error parses an error from the response
func (p *storage) Error(r *http.Response) error {
	var e Error
